...
//           <p className='font-bold text-sm md:text-lg mb-3 md:mb-5  text-gray-100 min-w-max'>Veloceeo</p>
//           <ul className='space-y-3 text-sm sm:text-base md:text-lg text-gray-300 '>
...
const Footer = () => {
  ...
  return (
    <footer className="bg-black text-white font-sans">
      <div className="w-full px-6 py-8 mb-4 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-10 justify-items-center items-stretch">
        {/* Logo & Contact Info */}
        <div className="flex flex-col gap-2 text-sm md:text-base">
          <img
            src={assets.yugant}
            alt="Yugant Logo"
            className="w-14 h-14 md:w-20 md:h-20 object-contain transition-transform duration-300 hover:scale-105 drop-shadow-lg"
          />
          ...
          <div className="flex space-x-4">
            <img
              src={assets.icon1}
              alt="Instagram"
              className="w-4 h-4 md:w-5 md:h-5 cursor-pointer transition-all duration-300 hover:scale-110 hover:opacity-80 filter brightness-90 hover:brightness-110"
            />
            <img
              src={assets.icon2}
              alt="YouTube"
          ...
          <div>
            <p className="font-bold text-sm md:text-lg mb-4  text-gray-100">
              GET IN TOUCH
            </p>
            <div className="flex items-start gap-3">
              <GrLocation className=" text-gray-400 group-hover:text-white transition-colors duration-300 flex-shrink-0" />
              <div>
                <p className="font-semibold text-gray-200">Location</p>
                <p className="text-gray-400 text-[10px] md:text-sm leading-relaxed hover:text-gray-300 transition-colors duration-300">
            ...
            <div className="flex items-start gap-3 ">
              <HiOutlineMail className=" text-gray-400 group-hover:text-white transition-colors duration-300 flex-shrink-0" />
              <div>
                <p className="font-semibold text-gray-200">Email</p>
                <p className="text-gray-400 text-[10px] md:text-sm hover:text-blue-400 transition-colors duration-300 cursor-pointer">
                  info@veloceeo.com
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <HiPhone className=" text-gray-400 group-hover:text-white transition-colors duration-300 flex-shrink-0" />
              <div>
                <p className="font-semibold text-gray-200">Phone</p>
                <p className="text-gray-400 text-[10px] md:text-sm hover:text-blue-400 transition-colors duration-300 cursor-pointer">
                  +91 6293800824
        ...
        <div className="flex flex-col items-center justify-start text-center  ">
          <p className="font-bold text-sm md:text-lg mb-4 pb-2 text-gray-100 min-w-max">Yugant</p>
          <ul className="space-y-3 text-sm sm:text-base md:text-lg text-gray-300">
            <li
              className="cursor-pointer hover:text-white transition-all duration-300 hover:translate-x-1 hover:font-medium"
              onClick={() => navigate('/')}
            >
              Home
            </li>
        ...
        {/* veloceo */}
        <div className="flex flex-col items-center justify-start text-center">
          <p className="font-bold text-sm md:text-lg mb-4 pb-2 text-gray-100 min-w-max">Veloceeo</p>
          <ul className="space-y-3 text-sm sm:text-base md:text-lg text-gray-300">
            <li
              className="cursor-pointer hover:text-white transition-all duration-300 hover:translate-x-1 hover:font-medium"
              onClick={() => handleBrandNav('#home')}
            >
              Home
            </li>
            <li
              className="cursor-pointer hover:text-white transition-all duration-300 hover:translate-x-1 hover:font-medium"
              onClick={() => handleBrandNav('#about')}
            >
              About Us
            </li>
            <li
              className="cursor-pointer hover:text-white transition-all duration-300 hover:translate-x-1 hover:font-medium"
              onClick={() => handleBrandNav('#innovation')}
            >
              Innovation
            </li>
            <li
              className="cursor-pointer hover:text-white transition-all duration-300 hover:translate-x-1 hover:font-medium"
              onClick={() => handleBrandNav('#vision')}
            >
              Vision
            </li>
            <li
              className="cursor-pointer hover:text-white transition-all duration-300 hover:translate-x-1 hover:font-medium"
              onClick={() => handleBrandNav('#contact')}
            >
              Contact Us
            </li>
          </ul>
        ...
        {/* Resources */}
        <div className="flex flex-col items-center justify-start text-center">
          <p className="font-bold text-sm md:text-lg mb-4 pb-2 text-gray-100 min-w-max">Resources</p>
          <ul className="space-y-3 text-sm sm:text-base md:text-lg text-gray-300">
            <li className="cursor-pointer hover:text-white transition-all duration-300 hover:translate-x-1 hover:font-medium">Blog</li>
            <li className="cursor-pointer hover:text-white transition-all duration-300 hover:translate-x-1 hover:font-medium">Best Practices</li>
            <li className="cursor-pointer hover:text-white transition-all duration-300 hover:translate-x-1 hover:font-medium">Colors</li>
